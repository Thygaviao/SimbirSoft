...
class CalculatorPage(BasePage):
    ...
    def return_memory_string(self):
        assert self.browser.find_element(By.XPATH, "//span[@class='vUGUtc']").text == '1 × 2 - 3 + 1 ='

    def return_result_string(self):
        assert self.browser.find_element(By.XPATH, "//span[@id='cwos']").text == '0'
